...
$query = "INSERT INTO mental_sum(score,operator) VALUES ('$results','$operator')";
...
<html>
    ...
    <body>
        ...
        ?>
        <br/>
        <a href="index.php"  class="ui-btn ui-btn-inline ui-mini ui-shadow ui-corner-all ui-alt-icon ui-nodisc-icon ui-icon-back">Back to Main Page</a>
    </body>
</html>
